...
Project Go uses **Gemini 2.0 Flash** (via a secure Netlify serverless function) with three specialized agent calls:
...
└── wastewise/
    ├── src/
    │   └── App.jsx          # Entire React app (~1700 lines)
    ├── netlify/
    │   └── functions/
